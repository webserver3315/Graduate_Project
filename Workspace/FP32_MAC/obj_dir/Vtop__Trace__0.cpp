...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+23,((1U & (vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__added_Mantissa 
                                     >> 0x16U))));
        bufp->chgIData(oldp+24,((0x7fffffU & vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__added_Mantissa)),23);
        bufp->chgIData(oldp+25,((0x7fffffU & (vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__added_Mantissa 
                                              >> 1U))),23);
        bufp->chgIData(oldp+26,(vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__lefted_frac),24);
        bufp->chgIData(oldp+27,((0xffffffU & (vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__lefted_frac 
                                              >> 1U))),24);
    ...
    bufp->chgIData(oldp+107,(((0x17U >= (0xffU & ((
                               ...
                               ? (0xffffffU & ((IData)(1U) 
                                               << (0xffU 
                                                   & ((((IData)(vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__E_LeftBig)
                                                      ...
                                                      - (IData)(1U)))))
                               : 0U)),24);
    bufp->chgBit(oldp+108,((1U & (((IData)(vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__E_LeftBig) 
                                   ...
                                   ? (vlSelf->FP32_MAC_Combinatorial__DOT__middle_output 
                                      >> 0x1fU) : (vlSelf->acc 
                                                   >> 0x1fU)))));
    bufp->chgIData(oldp+109,((0x7fffffU & ((((vlSelf->FP32_MAC_Combinatorial__DOT__middle_output 
                                              >> 0x1fU) 
                                             == (vlSelf->acc 
                                                 >> 0x1fU)) 
                                                ...
                                                : (
                                                   ...
                                                   ((0U 
                                                    ...
                                                    (vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__lefted_frac 
                                                     >> 1U)
                                                     : 0U)
                                                    : vlSelf->FP32_MAC_Combinatorial__DOT__My_Adder__DOT__lefted_frac))))),23);
